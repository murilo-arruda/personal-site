    ...
    <Layout>
      ...
      <S.About>
        ...
        <p>
          ...
          <S.Line>Tecnologia da Informação e Comunicação </S.Line> e dedico
          grande parte do meu tempo estudando e aprendendo novas tecnologias.
        </p>
        <p>
          ...
          <S.Line>Node</S.Line>, <S.Line>express</S.Line>,{' '}
          <S.Line>Redux</S.Line>, <S.Line>Vue</S.Line>, <S.Line>Gatsby</S.Line>,{' '}
          <S.Line>SASS</S.Line>, <S.Line>AWS</S.Line>, <S.Line>Netlify</S.Line>,{' '}
          <S.Line>Digital Ocean</S.Line>, <S.Line>Git</S.Line> e várias outras
          tecnologias relacionadas ao desenvolvimento WEB.
        </p>
        <p>
          <S.Line>Python</S.Line> é outra linguagem que tenho um grande carinho
          e que sempre estou explorando e me divertindo com esta linguagem,
          especial na área de Ciência de Dados. Embora Python seja minha
          linguagem favorita, também tenho conhecimento em <S.Line>C#</S.Line> e
          outra linguagens mais orientadas a objeto.
        </p>
        <p>
